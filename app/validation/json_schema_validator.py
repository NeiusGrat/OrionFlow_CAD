...
class FeatureGraphSchemaValidator:
    ...
    def validate_v1(data: Dict[str, Any]) -> ValidationResult:
        ...
        if "version" in data and data["version"] != "1.0":
            errors.append(
                f"Invalid version: expected '1.0', got '{data.get('version')}'"
            )
    ...
    def validate_and_repair(data: Dict[str, Any]) -> ValidationResult:
        ...
        try:
            ...
            return ValidationResult(valid=False, errors=errors, repaired_data=repaired)


def validate_llm_output(
    raw_response: str, parsed_data: Optional[Dict[str, Any]]
) -> Dict[str, Any]:
    """
