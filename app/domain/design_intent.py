...
class DesignIntent(BaseModel):
    ...
    symmetry: bool = Field(
        default=False, description="Is part symmetric about an axis?"
    )
    primary_load_axis: Optional[LoadAxis] = Field(
        None, description="Main direction of force/load"
    )
    ...
    material_preference: Optional[str] = Field(
        None, description="Material suggestion: aluminum, steel, plastic"
    )
