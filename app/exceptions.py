...
class InvalidPromptError(ValidationError):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, code=ErrorCode.INVALID_PROMPT, details=details
        )
...
class InvalidFeatureGraphError(ValidationError):
    ...
    def __init__(self, message: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message, code=ErrorCode.INVALID_FEATURE_GRAPH, details=details
        )
...
class LLMParseError(LLMError):
    ...
    def __init__(
        self,
        message: str = "Failed to parse LLM response as JSON",
        raw_response: str = None,
    ):
        details = {}
        if raw_response:
            details["raw_response_preview"] = (
...
class OnshapeSyncError(OrionFlowError):
    ...
    def __init__(
        self,
        message: str = "Failed to sync with Onshape",
        details: Optional[Dict[str, Any]] = None,
    ):
        super().__init__(
            message=message,
