...
from app.exceptions import CompilationError, ExportError
...
class BaseCompiler(ABC):
    ...
    def _export_geometry(
        self, part: Any, job_id: str, export_step_fn, export_stl_fn
    ) -> Dict[str, Path]:
        """
    ...
    def _validate_cfg(self, cfg) -> None:
        ...
        if not cfg.sketches and not cfg.features:
            raise CompilationError(
                message="FeatureGraph has no sketches or features", failed_feature=None
            )
