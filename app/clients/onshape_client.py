...
class OnshapeClient:
    ...
    def _make_auth_headers(
        self, method: str, path: str, query: Dict = {}, headers: Dict = {}
    ) -> Dict:
        ...
        signature = base64.b64encode(
            hmac.new(secret_key, msg, digestmod=hashlib.sha256).digest()
        ).decode("utf-8")
    ...
    def update_featurescript(
        self, did: str, wid: str, eid: str, script_content: str
    ) -> bool:
        """
        ...
        payload = {"contents": script_content, "lines": []}  # Optional: send as lines
    ...
    def update_variables(
        self, did: str, wid: str, eid: str, variables: Dict[str, float]
    ) -> bool:
        """
