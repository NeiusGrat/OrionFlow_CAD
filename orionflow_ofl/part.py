"""OFL Part — wraps a build123d solid with boolean subtraction support."""

from build123d import Cylinder as _Cylinder, Pos as _Pos

from .internal.errors import GeometryError
from .internal.selectors import get_z_extent, get_top_face_z


class Part:
    """Wraps a build123d solid. Supports ``part -= hole`` for subtractive cuts."""
