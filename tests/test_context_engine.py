...
from app.domain.feature_graph_v2 import FeatureGraphV2, FeatureV2
...
class TestDesignContext:
    ...
    def test_create_context(self):
        ...
        ctx = DesignContext(design_id="design_1", session_id="session_1")
...
class TestConversationHistory:
    ...
    def test_multiple_turns(self, engine_with_context):
        ...
        engine_with_context.add_conversation_turn("session_1", "user", "Create a box")
        engine_with_context.add_conversation_turn(
            "session_1", "assistant", "Created box feature"
        )
        engine_with_context.add_conversation_turn("session_1", "user", "Make it taller")
...
class TestReferenceResolution:
    ...
    def engine_with_history(self):
        ...
        ctx.last_topology_refs = {"edges": [">Z", "parallel_X"], "faces": [">Z"]}

        return engine

    def test_resolve_that_edge(self, engine_with_history):
        """Test 'that edge' resolution."""
        result = engine_with_history.resolve_reference("session_1", "fillet that edge")
    ...
    def test_resolve_make_taller(self, engine_with_history):
        ...
        result = engine_with_history.resolve_reference("session_1", "make it taller")
...
class TestContextPromptGeneration:
    ...
    def engine_with_full_context(self):
        ...
        # Add parameters
        ctx.current_parameters = {"width": 30, "height": 20, "depth": 10}
