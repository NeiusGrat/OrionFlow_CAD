...
def test_cnc_fillet_validator():
    ...
    feature = FeatureV2(id="fillet_1", type="fillet", params={"radius": 2.0})
...
def test_cnc_fillet_validator_passes_valid():
    ...
    feature = FeatureV2(id="fillet_1", type="fillet", params={"radius": 4.0})
...
def test_wall_thickness_validator():
    ...
    feature = FeatureV2(
        id="extrude_1", type="extrude", sketch="s1", params={"depth": 1.0}
    )
...
def test_hole_standards_validator():
    ...
    feature = FeatureV2(id="hole_1", type="hole", params={"diameter": 7.0})
