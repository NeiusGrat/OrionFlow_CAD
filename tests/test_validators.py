    ...
    graph = FeatureGraphV2(
        ...
        sketches=[
            SketchGraphV2(
                ...
                primitives=[
                    SketchPrimitiveV2(
                        id="p1", type="rectangle", params={"width": 50, "height": 30}
                    )
                ],
            )
        ],
        features=[
            FeatureV2(
                id="extrude_1", type="extrude", sketch="s1", params={"depth": "$depth"}
            )
        ],
    )
    ...
    graph = FeatureGraphV2(
        ...
        sketches=[
            SketchGraphV2(
                ...
                primitives=[
                    SketchPrimitiveV2(
                        id="p1", type="rectangle", params={"width": 10, "height": 10}
                    )
                ],
            )
        ],
        features=[
            FeatureV2(
                id="extrude_1", type="extrude", sketch="s1", params={"depth": 10}
            ),
            FeatureV2(
                id="fillet_1",
                type="fillet",
    ...
    graph = FeatureGraphV2(
        ...
        sketches=[
            SketchGraphV2(
                ...
                primitives=[
                    SketchPrimitiveV2(
                        id="p1", type="rectangle", params={"width": 20, "height": 20}
                    )
                ],
            )
        ],
        features=[
            ...
            FeatureV2(
                ...
                topology_refs={
                    "edges": SemanticSelector(
                        selector_type=SelectorType.STRING, string_selector=">Z"
                    )
                },
            ),
        ],
...
def test_valid_geometry_passes():
    ...
    graph = FeatureGraphV2(
        ...
        features=[
            FeatureV2(
                id="extrude_1", type="extrude", sketch="s1", params={"depth": "$height"}
            ),
            FeatureV2(
                id="fillet_1",
                type="fillet",
