                ...
                <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{
                        ...
                        <section style={{ marginBottom: '40px' }}>
                            ...
                            <p style={{ color: '#A79D8B', marginBottom: '16px' }}>
                                <strong style={{ color: '#EFE7D8' }}>Your Content:</strong> You retain all rights to the CAD models and designs you create using our service. By using OrionFlow, you grant us a limited license to process and store your designs for the purpose of providing our service.
                            </p>
                            <p style={{ color: '#A79D8B' }}>
                                <strong style={{ color: '#EFE7D8' }}>Our Content:</strong> The OrionFlow platform, including its AI models, user interface, and underlying technology, remains our intellectual property.
                            </p>
                        </section>
